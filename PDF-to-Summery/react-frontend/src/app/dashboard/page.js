...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen items-center max-w-[700px] m-auto pt-5">
      ...
      <h1 className="text-3xl mt-5 font-bold">PDF to Summary</h1>
      <div>
      ...
      {Summary ? (
        <div className="w-full px-8 mt-5">
          <p className="text-lg text-center font-semibold">Summary</p>
          <p
            dangerouslySetInnerHTML={{ __html: Summary }}
            className="text-md mt-5 text-left whitespace-pre-line "
          ></p>
          <div className="w-fit m-auto mt-10">
            <Button className="mt-10 m-auto" onClick={() => anotherSummary()}>
      ...
      <p className="m-5 text-sm text-center mt-10">Click on log out to clear clear the session <br/> <span className="text-red-400 text-sm" onClick={logOut}>Log Out</span> </p>
